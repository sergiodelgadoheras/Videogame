...
//funciones globales publicas 
	...
	//CLASE SPRITE------------------------------------------------------------
	//un rectangulo con textura que facilita el dibujo y animaci�n en pantalla
	class Sprite
	{
	public:
		...
		float getPosX();// NO esta en game kendra
		float getPosY();// NO esta en game kendra
	...
	//un sprite con una secuencia de imagenes que hacen una animaci�n.
	...
	inline float Sprite::getPosX() { return pos.x; }; // no esta
	inline float Sprite::getPosY() { return pos.y; }; // no esta
